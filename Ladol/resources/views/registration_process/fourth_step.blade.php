                    ...
                    <div class="col-md-9">
                        <div class="panel panel-info  ">
                            <div class="panel-heading main-color-bg">
                                <h3 class="panel-title">Job Roles Setup</h3>
                            </div>

                            <div class="panel-body" style="padding-top: 15px;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="list-group-item-text">Import the job roles in your organization. Click on the link below and fill as shown in the example by the right. <br>
                                            <a href="{{url('import/download_jobroles_template')}}">Download Template for Job Roles setup</a>
                                        </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="type" value="jobroles">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{asset('assets/images/job_roles_import_demo.png')}}" alt="">
                                    </div>
                                </div>
