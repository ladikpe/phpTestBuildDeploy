          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-info panel-line">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Company Departments</h3>
            ...
            <table class="table table-stripped" id="">
              ...
              <tbody>
                ...
                <span  data-toggle="tooltip" title="View"><a href="{{ url('dept-organogram/'.$department->id) }}"  class="btn-sm btn btn-info   "><i class="fa fa-eye" aria-hidden="true"></i></a></span>
            </td>
              ...
              {!! $departments->appends(Request::capture()->except('page'))->render() !!}
          </div>
        </div>
