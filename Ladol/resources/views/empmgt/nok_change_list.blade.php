...
" aria-hidden="true"></i>Dependant Change</a>
            ...
            <div class="page-main" style="min-height:700px;">
                ...
                <div class="page-header">
                    <h1 class="page-title">Next of Kin Change Approval</h1>
              ...
              <label for="select_all"></label>
                    ...
                    <!-- Mailbox -->
                        <table id="mailboxTable" class="table" data-plugin="animateList" data-animate="fade"
                            ...
                            @foreach($changes as $change)
                                    ...
                                    <tr id="mid_1" data-url="{{url('userprofile/view_nok_change').'?change_id='.$change->id.'&type=user'}}" data-toggle="slidePanel" style="">
                ...
                <span class="checkbox-custom checkbox-primary checkbox-lg">
                  ...
                  <label for="mail_mid_1"></label>
                                        ...
                                        <td>
                                            <div class="content">
                                                <div class="title">{{$change->user?$change->user->name:''}} is requesting approval for a change in their Next of Kin Information </div>
    ...
    <script>
        ...
        function rejectChange(user_id){
            alertify.confirm('Are you sure you want to reject this change ?', function () {
                ...
                $.get('{{ url('userprofile/reject_nok_changes') }}',{user_id:user_id},function(data){
                    if (data=='success') {
