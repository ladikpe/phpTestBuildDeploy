...
<div class="page ">
    <div class="page-header">
      <h1 class="page-title">My Team Organogram</h1>
          ...
          <div class="col-md-12">
            ...
            <div class="panel panel-info ">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Team Lead :{{Auth::user()->name}}</h3>
              </div>
        ...
        nodeStructure: {
          HTMLid:{{Auth::user()->id}},
            text: {
                ...
                title: "{{Auth::user()->job->title?Auth::user()->job->title:''}}",
                contact: "{{Auth::user()->grade?Auth::user()->grade->level:''}}",
            }, @if (Auth::user()->pdreports)
             children: [
             @foreach (Auth::user()->pdreports as $dr)
               {
                    HTMLid:{{$dr->id}},
                    text:{
                        name: "{{$dr->name}}",
