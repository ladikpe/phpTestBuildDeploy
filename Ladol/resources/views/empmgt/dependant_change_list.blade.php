                        ...
                        <div data-role="content">
                            <div class="page-aside-section">
                                <div class="list-group">
                                    <a class="list-group-item " href="{{url('userprofile/change_approval')}}"><i class="icon md-account" aria-hidden="true"></i>Employee Information Changes</a>
                                    <a class="list-group-item active" href="{{url('userprofile/nok_change_approval')}}"><i class="icon md-accounts" aria-hidden="true"></i>Next of Kin Changes</a>
                                    <a class="list-group-item active" href="{{url('userprofile/educational_history_change_approval')}}"><i class="icon md-accounts-list
" aria-hidden="true"></i>Academic History</a>
                                    <a class="list-group-item active" href="{{url('userprofile/employment_history_change_approval')}}"><i class="icon md-accounts-list
" aria-hidden="true"></i>Employment History</a>
                                    <a class="list-group-item active" href="{{url('userprofile/dependant_change_approval')}}"><i class="icon md-accounts-list
" aria-hidden="true"></i>Dependant Change</a>
            ...
            <div class="page-main" style="min-height:700px;">
                ...
                <div class="page-header">
                    <h1 class="page-title">Dependant Change Approval</h1>
              ...
              <label for="select_all"></label>
                    ...
                    <!-- Mailbox -->
                        <table id="mailboxTable" class="table" data-plugin="animateList" data-animate="fade"
                            ...
                            @foreach($changes as $change)
                                    ...
                                    <tr id="mid_1" data-url="{{url('userprofile/view_dependant_change').'?change_id='.$change->id.'&emp_id='.$change->emp_id}}" data-toggle="slidePanel" style="">
                ...
                <span class="checkbox-custom checkbox-primary checkbox-lg">
                  ...
                  <label for="mail_mid_1"></label>
                                        ...
                                        <td>
                                            <div class="content">
                                                <div class="title">{{$change->user?$change->user->name:''}} is requesting approval for a change in their Dependant Information </div>
...
@section('scripts')
    ...
    <script>
        ...
        function rejectChange(eh_id,emp_id){
            alertify.confirm('Are you sure you want to reject this change ?', function () {


                $.get('{{ url('userprofile/reject_dependant_changes') }}',{emp_id:emp_id,eh_id:eh_id},function(data){
                    if (data=='success') {
                ...
                alertify.error('Changes to dependant information could not be rejected');
            });
        }
    </script>
@endsection
