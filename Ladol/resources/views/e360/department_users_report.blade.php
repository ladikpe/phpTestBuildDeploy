              ...
              <table class="table table-striped" id="userstable">
                ...
                <tbody>
                  ...
                  @foreach ($det->department->users as $user)
                    ...
                    <td>{{$user->othersreviews?$user->othersreviews->where('e360_det_id',$det->id)->count():"0"}}</td>

                    <td><a href="{{url('e360/get_evaluation_report')."/?det=".$det->id."&employee=".$user->id}}"   class="btn btn-info   btn-sm"   ><i class="fa fa-eye" aria-hidden="true"></i>View Evaluation Report</a></td>
                    </tr>
                  @php
                    $sn++;
                  @endphp
