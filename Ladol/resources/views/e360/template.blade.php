...
@section('content')
    <div class="page ">
        <div class="page-header">
            <h1 class="page-title">360 Degree Review - Questions - Measurement Periods</h1>
                                ...
                                <table class="table table-striped ">
                                    ...
                                    @foreach($measurement_periods as $measurement_period)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info" href="{{url('e360settings/get_det?mp='.$measurement_period->id)}}">View Questions </a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
