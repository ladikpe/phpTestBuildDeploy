...
@section('content')
    ...
    <div class="page ">
        <div class="page-header">
            <h1 class="page-title">KPI Supervisor Panel : {{ auth()->user()->name }}</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/')}}">{{__('Home')}}</a></li>
                <li class="breadcrumb-item active">KPI Supervisor Panel</li>
            </ol>
                ...
                <div class="col-lg-3 masonry-item">
                    <div class="panel panel-info panel-line">
                        <div class="panel-heading">
                            <h3 class="panel-title">KPI Measurement Periods</h3>
                        </div>
...
@section('scripts')
    <script>
        function loadUsers(period) {
            url = '{{url('load/supervisor/kpi-users')}}?measurement_period='+period,
