<div class="modal fade in modal-3d-flip-horizontal modal-info" id="addAccountModal" aria-hidden="true" aria-labelledby="addAccountModal" role="dialog" tabindex="-1">
	    <div class="modal-dialog modal-lg">
	        ...
	        <div class="modal-header" >
	          ...
	          <h4 class="modal-title" id="training_title">Add Account</h4>
	        </div>
          <form class="form-horizontal" id="addAccountForm"  method="POST">
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                <div class="form-group">
                                        ...
                                        <select required name="account_type" style="width:100%;" id="account_type" class="form-control " >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select required name="display" style="width:100%;" id="display" class="form-control " >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select  name="source" style="width:100%;" id="source" class="form-control " >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="example-title" for="display">Uses Group</label>

                                <select required="" name="uses_group" style="width:100%;" id="uses_group" class="form-control " >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select  name="salary_charge" style="width:100%;" id="group_id" class="form-control " >
