...
<div id="edit-loan-type-form" class="modal fade" role="dialog">
    <div class="modal-dialog modal-info modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="edit-loan-type-button" type="button" class="btn btn-success btn-sm">Update</button>
