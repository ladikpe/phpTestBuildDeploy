          ...
          <div class="col-md-9">            
            <div class="panel panel-info panel-line">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">New Budget</h3>
                <div class="panel-actions">
                  <a href="{{ route('training') }}" class="btn btn-info">List Budget</a>
                </div>
              </div>
                ...
                {{ csrf_field() }}
                  <div class="panel panel-info panel-line" style="">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" placeholder="" id="purpose" name="purpose" required="">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" placeholder="" id="amount" name="amount" required="">
                          </div>
                    ...
                    <div class="panel-footer" style="margin-bottom: 20px; margin-right: 15px">
                      <button type="submit" class="btn btn-success pull-right"> Create Budget </button>
                    </div> <br>
                  </div>
              </form>
