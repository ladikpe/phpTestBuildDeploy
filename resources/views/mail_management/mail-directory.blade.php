...
<div class="page ">
  <div class="page-header">
    <a href=""> <h1 class="page-title">Mail Management</h1> </a>

    <div class="panel-heading main-color-bg" style="color: #fff;">
      <div class="panel-actions">
        <a class="btn btn-primary" data-toggle="modal" data-target="#newHMOModal">New Mail</a>
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12">
            <div class="panel panel-info ">
              ...
              <div class="panel-heading main-color-bg" style="margin-bottom: 10px;">
                <h3 class="panel-title"> Mail Directory </h3>
              </div>
              ...
              <div class="panel-body">
                <div class="col-md-13">  
                 ...
                 <table id="data_table" class="table">
                  ...
                  @if(count($allMail) == '0')
                  <tr>
                    <td colspan="9">  <h4 style="padding: 30px;">No mail found.</h4> </td>
                  </h4>
                  @endif
...
<div class="modal fade in modal-3d-flip-horizontal modal-info" id="newHMOModal" aria-hidden="true" aria-labelledby="addHolidayModal" role="dialog" tabindex="-1">
      <div class="modal-dialog ">
        <form class="form-horizontal" action="/new-mail" method="post" enctype="multipart/form-data">
                    @csrf
          <div class="modal-content">        
          <div class="modal-header" >
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title" id="training_title">New Mail</h4>
          </div>
  ...
  <div class="modal fade in modal-3d-flip-horizontal modal-info" id="editMailModal" aria-hidden="true" aria-labelledby="editHMOModal" role="dialog" tabindex="-1">
      <div class="modal-dialog ">
        <form class="form-horizontal" action="/edit-mail" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-header" >
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title" id="training_title">Modify Mail</h4>
          </div>
...
<script type="text/javascript">
  ...
  function deleteMail(id) {
    alertify.confirm('Are you sure you want to delete this Mail?', function () {
      $.get('{{ url('/mail-delete/') }}/' + id, function (data) {
        if (data == 'success') {
          toastr["success"]("Mail deleted successfully", 'Success');
          location.reload();
        } else {
          toastr["error"]("Error deleting Mail", 'Success');
        }
      });
    }, function () {
