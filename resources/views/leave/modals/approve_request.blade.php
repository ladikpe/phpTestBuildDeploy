<div class="modal fade in modal-3d-flip-horizontal modal-info" id="approveLeaveRequestModal" aria-hidden="true"
  aria-labelledby="approveLeaveRequestModal" role="dialog" tabindex="-1">
