    ...
    <div class="page-header">
      <div>
        @if(auth()->user()->job_id == '1')
          <h1 class="page-title">Udemy Dashboard</h1>
        ...
        <div class="page-header-actions">
            <div class="row no-space hidden-sm-down">
                <div class="col-sm-12 col-xs-12">
                    @if(auth()->user()->job_id == '1')
                        <a href = "{{route('evaluate.report')}}" class = "btn custom-btn"><i class="icon fa fa-list"
                            aria-hidden="true"></i>&nbsp;View Reports
                        </a>
                    @elseif(auth()->user()->job_id == "3" )
                        <div class="boxer">
                            <div>
                                <a href  = "{{url('training/manager/trainings')}}" class = "btn custom-btn"><i class="icon fa fa-list"
                                    aria-hidden="true"></i>&nbsp;View Reports
                                </a>
                            </div>
                            <div>
...
<div class="page-content container-fluid">   
    <div class="row">
        <div class="col-xl-4 col-md-6 col-xs-12 info-panel marg">
                ...
                <div class="card custom-card">
                    <div class="card-block bg-white p-30">
                        <div class = "rowflex">
                            ...
                            <div class="font-weight-400 custom-typo">User Activities</div>  
                        </div>
                        <div class="content-text text-xs-center m-b-0">
                            <div class = "counter-box">
                                <h3 class="number_demo" style = "font-weight:lighter;">{{$users}}</h3>
