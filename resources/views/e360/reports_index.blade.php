...
<div class="page ">
    <div class="page-header">
      <h1 class="page-title">360 Degree Review - Reports - Measurement Periods</h1>
            ...
            <div class="panel panel-info ">
              ...
              <div class="panel-body">
                  <div class="col-md-12">
                      ...
                      <tbody>
                          @foreach($mps as $measurement_period)
                      <tr>
                            <td>{{date('F-Y',strtotime($measurement_period->from))}} - {{date('F-Y',strtotime($measurement_period->to))}}</td>
                        <td><a class="btn btn-info" href="{{url('e360/report_users?mp='.$measurement_period->id)}}">View Employees </a></td>
                        </tr>
                      @endforeach
                      </tbody>
