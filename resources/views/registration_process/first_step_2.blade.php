                    ...
                    <div class="col-md-3">
                        <div class="list-group list-group-gap">
                            <a class="list-group-item active" href="javascript:void(0)">
                                <h4 class="list-group-item-heading">Grade Setup</h4>
                                <p class="list-group-item-text">Setup the grade levels in your organization</p>
                            </a>
                            <a class="list-group-item disabled" href="javascript:void(0)">
                                <h4 class="list-group-item-heading">Branches Setup</h4>
                                <p class="list-group-item-text">Setup the various branches in your Organization</p>
                            </a>
                            <a class="list-group-item disabled" href="javascript:void(0)">
                                <h4 class="list-group-item-heading">Department Setup</h4>
                                <p class="list-group-item-text">Setup the various departments in your Organization</p>
                            </a>
                            <a class="list-group-item disabled" href="javascript:void(0)">
                                <h4 class="list-group-item-heading">Job Roles Setup</h4>
                                <p class="list-group-item-text">Setup the various Job roles in your organization</p>
                            </a>
                            <a class="list-group-item disabled" href="javascript:void(0)">
                    ...
                    <div class="col-md-9">
                        <div class="panel panel-info  ">
                            <div class="panel-heading main-color-bg">
                                <h3 class="panel-title">Grade Setup</h3>
                            </div>

                            <div class="panel-body" style="padding-top: 15px;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="list-group-item-text">Import the grades in your organization. Click on the link below and fill as shown in the example by the right. <br>
                                            <a href="{{url('import/download_grades_template')}}">Download Template for Grade setup</a>
                                        </p>
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{asset('assets/images/grade_import_demo.png')}}" alt="">
                                    </div>
                                </div>
