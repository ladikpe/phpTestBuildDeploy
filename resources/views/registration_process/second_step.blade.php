                    ...
                    <div class="col-md-3">
                        <div class="list-group list-group-gap">
                            <div class="list-group-item list-group-item-success " >
                                <h4 class="list-group-item-heading text-white" style="color: white">Grade Setup</h4>
                            ...
                            <a class="list-group-item disabled" href="javascript:void(0)">
                                <h4 class="list-group-item-heading">Departments Setup</h4>
                    ...
                    <div class="col-md-9">
                        <div class="panel panel-info  ">
                            <div class="panel-heading main-color-bg">
                                <h3 class="panel-title">Branches Setup</h3>
                            </div>

                            <div class="panel-body" style="padding-top: 15px;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="list-group-item-text">Import the branches in your organization. Click on the link below and fill as shown in the example by the right. <br>
                                            <a href="{{url('import/download_branches_template')}}">Download Template for Branch setup</a>
                                        </p>
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{asset('assets/images/branch_import_demo.png')}}" alt="">
                                    </div>
                                </div>
