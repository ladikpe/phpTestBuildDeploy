<!--- Add Subject modal start -->
  <div class="modal fade in modal-3d-flip-horizontal modal-primary" id="addBehavioralSubMetricModal" aria-hidden="true" aria-labelledby="addBehavioralSubMetricModal"
  role="dialog" tabindex="-1">
   
    <div class="modal-dialog modal-lg">
      <form class="form-horizontal" id="addBehavioralSubMetricForm" role="form" method="POST">
        <div class="modal-content">        
        <div class="modal-header" >
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          
          <h4 class="modal-title" id="training_title">Add Behavioral Sub Metric</h4>
        </div>
          ...
          <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="measure" class="form-control"  required></textarea>
                              </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" name="weighting" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
