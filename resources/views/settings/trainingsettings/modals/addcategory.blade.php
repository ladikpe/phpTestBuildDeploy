<div class="modal fade in modal-3d-flip-horizontal modal-info" id="addCategoryModal" aria-hidden="true" aria-labelledby="addCategoryModal" role="dialog" tabindex="-1">
	    <div class="modal-dialog modal-dialog-scrollable">
	      <form class="form-horizontal" id="addCategoryForm"  method="POST">
	        <div class="modal-content">
	        <div class="modal-header" >
	          <button type="button" class="close" data-dismiss="modal">&times;</button>
	          <h4 class="modal-title" id="training_title">Add Training Category</h4>
	        </div>
                ...
                <div class="row row-lg col-xs-12">
                  <div class="col-xs-12" style = "width:100%;">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows = "5" name = "description" id = "category_description"></textarea>
                    </div>
                  </div>
