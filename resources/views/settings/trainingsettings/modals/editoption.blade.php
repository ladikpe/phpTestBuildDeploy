<div class="modal fade in modal-3d-flip-horizontal modal-info" id="editQuestionOptionModal" aria-hidden="true" aria-labelledby="addQuestionOptionModal" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-dialog-scrollable">
    <form class="form-horizontal" id="editQuestionOptionForm"  method="POST">
            ...
            <div class="row row-lg col-xs-12">
              <div class="col-xs-12" style = "width:100%;">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name = "option" id = "edit_option"/>
                </div> 
                <div class="form-group mt-2">
                  <h4 class="example-title">Mark obtainable</h4>
                  <input class="form-control" type="text" name = "mark" id = "edit_mark"/>
                </div> 
            </div>
            </div>
        </div>
