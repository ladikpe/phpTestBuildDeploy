<div class="modal fade in modal-3d-flip-horizontal modal-info" id="addShiftModal" aria-hidden="true"
     aria-labelledby="addShiftModal" role="dialog" tabindex="-1">
                    ...
                    <div class="row row-lg col-xs-12">
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="colorpicker-default form-control colorInputUi-input"  value="#ff666b" name="color_code">
                            </div>
                        </div>
