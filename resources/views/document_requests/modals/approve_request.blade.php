<div class="modal fade in modal-3d-flip-horizontal modal-info" id="approveDocumentRequestModal" aria-hidden="true" aria-labelledby="approveDocumentRequestModal" role="dialog" tabindex="-1">
	    <div class="modal-dialog ">
	      <form class="form-horizontal" id="approveDocumentRequestForm" enctype="multipart/form-data">
          ...
          <input type="hidden" name="document_request_approval_id" id="approval_id" >
