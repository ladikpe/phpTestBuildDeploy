<div class="modal fade in modal-3d-flip-horizontal modal-info" id="approvePayrollModal" aria-hidden="true"
  aria-labelledby="approvePayrollModal" role="dialog" tabindex="-1">
  <div class="modal-dialog ">
    <form class="form-horizontal" id="approvePayrollForm" enctype="multipart/form-data">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" id="training_title">Approve Payroll</h4>
        </div>
