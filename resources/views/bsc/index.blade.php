              ...
              <div class="panel-body">
                  <div class="col-md-12">
                      ...
                      <tr>
                        ...
                        <td><a class="btn btn-info" href="{{url('bsc/get_evaluation_user_list?mp='.$measurement_period->id.'&operation='.request()->operation.'&mptype='.$measurement_period->type)}}">View Users</a></td>
                        </tr>
                      @endforeach
                      </tbody>
