...
class PayrollRejected extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('Payroll Approval request rejected')
            ->line('The payroll approval request for , '.date('M, Y',strtotime($this->payroll_approval->payroll->for)).' which you submitted for approval has been Rejected.')
